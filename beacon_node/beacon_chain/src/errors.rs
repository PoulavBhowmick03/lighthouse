...
pub enum BeaconChainError {
    ...
    MissingBeaconBlock(Box<Hash256>),
    MissingBeaconState(Box<Hash256>),
    MissingHotStateSummary(Box<Hash256>),
    SlotProcessingError(SlotProcessingError),
    EpochProcessingError(EpochProcessingError),
    StateAdvanceError(StateAdvanceError),
    UnableToAdvanceState(String),
    NoStateForAttestation {
        beacon_block_root: Box<Hash256>,
    },
    ...
    BadPreState {
        parent_root: Box<Hash256>,
        parent_slot: Slot,
        block_root: Box<Hash256>,
        block_slot: Slot,
        state_slot: Slot,
    },
    ...
    InconsistentPayloadReconstructed {
        ...
        canonical_transactions_root: Box<Hash256>,
        reconstructed_transactions_root: Box<Hash256>,
    },
    ...
    AttestationHeadNotInForkChoice(Box<Hash256>),
